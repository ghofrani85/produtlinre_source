 ...
 *
 */
public class PictureArtefact extends Artefact {
	...
	/**
	 * @param id The ID of the picture artefact in the databse
	 ...
	 */
	public PictureArtefact(Integer id, String title, Asset asset, String x, String y, String width, String height) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PictureArtefact)) {
			return false;
		}
